...
curl -X PUT $url/skillsets/margies-skillset?api-version=2024-03-01-Preview -H "Content-Type: application/json" -H "api-key: $admin_key" -d @skillset.json


echo -----
echo Updating the index...
curl -X PUT $url/indexes/margies-index?api-version=2024-03-01-Preview -H "Content-Type: application/json" -H "api-key: $admin_key" -d @index.json



echo -----
echo Updating the indexer...
curl -X PUT $url/indexers/margies-indexer?api-version=2024-03-01-Preview -H "Content-Type: application/json" -H "api-key: $admin_key" -d @indexer.json
